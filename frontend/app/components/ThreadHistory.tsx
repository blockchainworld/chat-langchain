...
import { SquarePen, History, Trash2, Info, LogIn } from "lucide-react";
...
interface ThreadHistoryProps {
  ...
  setSelectedPage: (page: "chat" | "about" | "login") => void;
}
      ...
      <div className="hidden md:flex flex-col w-[260px] h-full">
        <div className="flex-grow border-r-[1px] border-[#393939] my-6 flex flex-col overflow-hidden">
          ...
          <div className="flex flex-col gap-2 px-4 py-2">
            <Button variant="ghost" onClick={() => props.setSelectedPage("about")}>
              <Info className="w-5 h-5 mr-2" />
              About
            </Button>
            <Button variant="ghost" onClick={() => props.setSelectedPage("login")}>
      ...
      <span className="md:hidden flex flex-row gap-2 mt-2 ml-2">
        ...
        <div className="flex flex-row gap-2">
          <TooltipIconButton
            ...
            variant="ghost"
            className="w-fit h-fit p-2"
            onClick={() => props.setSelectedPage("about")}
          >
          ...
          <TooltipIconButton
            ...
            variant="ghost"
            className="w-fit h-fit p-2"
            onClick={() => props.setSelectedPage("login")}
          >
